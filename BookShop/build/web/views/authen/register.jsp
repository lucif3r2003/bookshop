                        ...
                        <div class="row m-0">
                            <div class="col-sm-12 sign-in-page-data">
                                <div class="sign-in-from bg-primary rounded">
                                    ...
                                    <form class="mt-4 form-text" action="${pageContext.request.contextPath}/authen?action=register" method="POST"">
                                        <!--Username-->
                                        <div class="form-group">
                                            <label for="usernameInput">Username</label>
                                            <input type="text" name="username" class="form-control mb-0" id="usernameInput" placeholder="Enter username">
                                        </div>
                                        <!--Password-->
                                        <div class="form-group">
